    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 to-slate-800 p-4">
      <div className="glass-card w-full max-w-md p-8 rounded-2xl animate-fade-in shadow-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-300">Join EPHY</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            ...
            className="w-full py-3 px-4 bg-gradient-to-r from-[#ff7a59] to-[#e5694d] text-white font-medium rounded-lg hover:shadow-lg hover:shadow-[#ff7a59]/30 transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed btn-glow mt-2"
          >
        ...
        <p className="mt-6 text-center text-slate-400 text-sm">
          ...
          <Link href="/login" className="text-[#ff7a59] hover:text-[#e5694d] font-medium transition-colors">
            Sign in
          </Link>
        </p>
      </div>
